...
type User struct {
	...
	Email      string `json:"email" form:"email"  gorm:"type:varchar(100);comment:用户邮箱" zwlog:"cu"`
	Mobile     string `json:"mobile" form:"mobile"   gorm:"type:varchar(50);comment:用户手机" zwlog:"cu"`
	UserName   string `json:"user_name" form:"user_name" gorm:"uniqueIndex:idx_users_user_name;type:varchar(100);comment:用户名" binding:"required,zw_username" zwlog:"cu"`
	NickName   string `json:"nick_name" form:"nick_name" gorm:"type:varchar(100); comment:用户昵称" zwlog:"cu"`
	...
	MFASwitch  bool   `json:"mfa_switch" form:"mfa_switch" gorm:"comment:mfa虚拟认证" zwlog:"cu"`
	...
	ATime      int64  `json:"atime" form:"uatime" gorm:"column:atime;autoUpdateTime:milli;comment:访问时间"`
}
